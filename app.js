    ...
    const C = {
      void: '#050C1A',    // deepest navy background
      deep: '#071020',    // slightly lighter navy
      surface: '#0C1A30', // card/panel background
      panel: '#112240',   // elevated panel
      border: 'rgba(196,160,80,0.15)',       // gold border subtle
      borderBright: 'rgba(196,160,80,0.35)', // gold border active
      cyan: '#C4A050',        // PRIMARY gold (replaces cyan everywhere)
      cyanBright: '#E2BE78',  // bright gold
      cyanDim: 'rgba(196,160,80,0.08)',      // gold tint background
      text: '#F5EDD8',         // warm off-white — max readability on navy
      muted: '#9A8A6A',        // warm muted gold-tan
      dim: '#4A5A78',          // navy-blue dim
      brains: {
