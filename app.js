const { useState, useEffect, useCallback, useRef, useMemo } = React;
    ...
    function AuthModal({ onClose, onSuccess, initialTab = 'login' }) {
      ...
      return (
        React.createElement("div", {style: {
          ...
          backdropFilter:'blur(8px)',
        }}, React.createElement("div", {className: "card fade-up", style: { maxWidth:420, width:'100%', padding:'36px 32px', position:'relative' }}, React.createElement("button", {onClick: onClose, style: { position:'absolute', top:16, right:16, background:'none', border:'none', color:C.muted, fontSize:20, cursor:'pointer', lineHeight:1 }}, '×'), React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:3, color:C.cyan, marginBottom:20 }}, 'Authentication'), React.createElement("div", {style: { ...syne, fontSize:24, fontWeight:800, color:C.text, marginBottom:6 }}, title), React.createElement("div", {style: { fontSize:13, color:C.muted, marginBottom:28 }}, sub), (tab==='login'||tab==='signup') && (
            ...
            ), tab==='login' && (React.createElement(React.Fragment, null, React.createElement("div", {style: { marginBottom:14 }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:2, color:C.muted, marginBottom:8 }}, 'Email'), React.createElement("input", {type: "email", value: email, onChange: e=>setEmail(e.target.value), placeholder: "you@example.com"})), React.createElement("div", {style: { marginBottom:8 }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:2, color:C.muted, marginBottom:8 }}, 'Password'), React.createElement("input", {type: "password", value: password, onChange: e=>setPassword(e.target.value), placeholder: "••••••••", onKeyDown: e=>e.key==='Enter'&&handleLogin()})), React.createElement("div", {style: { textAlign:'right', marginBottom:20 }}, React.createElement("button", {onClick: ()=>{ setTab('forgot-password'); setMsg({text:'',type:''}); }, style: {
                  background:'none', border:'none', ...mono, fontSize:9, letterSpacing:1,
                  color:C.muted, cursor:'pointer', textDecoration:'underline',
                }}, 'Forgot password?')))), tab==='signup' && (React.createElement(React.Fragment, null, React.createElement("div", {style: { marginBottom:14 }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:2, color:C.muted, marginBottom:8 }}, 'Full name'), React.createElement("input", {value: name, onChange: e=>setName(e.target.value), placeholder: "Your name"})), React.createElement("div", {style: { marginBottom:14 }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:2, color:C.muted, marginBottom:8 }}, 'Email'), React.createElement("input", {type: "email", value: email, onChange: e=>setEmail(e.target.value), placeholder: "you@example.com"})), React.createElement("div", {style: { marginBottom:24 }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:2, color:C.muted, marginBottom:8 }}, 'Password'), React.createElement("input", {type: "password", value: password, onChange: e=>setPassword(e.target.value), placeholder: "••••••••", onKeyDown: e=>e.key==='Enter'&&handleSignup()})))), tab==='forgot-password' && (React.createElement(React.Fragment, null, React.createElement("div", {style: { marginBottom:24 }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:2, color:C.muted, marginBottom:8 }}, 'Email'), React.createElement("input", {type: "email", value: email, onChange: e=>setEmail(e.target.value), placeholder: "you@example.com", onKeyDown: e=>e.key==='Enter'&&handleForgotPassword()})))), tab==='update-password' && (React.createElement(React.Fragment, null, React.createElement("div", {style: { marginBottom:14 }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:2, color:C.muted, marginBottom:8 }}, 'New password'), React.createElement("input", {type: "password", value: password, onChange: e=>setPassword(e.target.value), placeholder: "••••••••"})), React.createElement("div", {style: { marginBottom:24 }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:2, color:C.muted, marginBottom:8 }}, 'Confirm password'), React.createElement("input", {type: "password", value: confirmPassword, onChange: e=>setConfirmPassword(e.target.value), placeholder: "••••••••", onKeyDown: e=>e.key==='Enter'&&handleUpdatePassword()})))), msg.text && (
            ...
            React.createElement("div", {style: {
              ...
              backdropFilter:'blur(20px)', paddingTop:70, display:'flex', flexDirection:'column',
                ...
                animation:'fadeUp 0.35s ease 0.35s both',
                  ...
                  React.createElement("div", {style: { display:'flex', flexDirection:'column', gap:10 }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:3, color:C.muted, marginBottom:4 }}, 'Cognitive performance OS'), React.createElement("button", {className: "btn-primary", style: { width:'100%', fontSize:12, textAlign:'center' }, onClick: ()=>{ setShowAuth(true); setMenuOpen(false); }}, 'Sign in →'))
                )))
          ))
      );
    }
...
function HomeView({ setView, user, setShowAuth, cfiResult, lessonProgress, sessions }) {
  ...
  return (
      ...
      return (
        React.createElement("div", {style: { paddingTop:80, paddingBottom:100 }}, React.createElement("div", {style: { maxWidth:1200, margin:'0 auto', padding:'40px 24px' }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:4, color:C.cyan, marginBottom:16 }}, 'Four Brains framework'), React.createElement("h1", {style: { ...syne, fontSize:28, fontWeight:800, color:C.text, marginBottom:16, lineHeight:1.05 }}, 'The architecture', React.createElement("br", null), 'of human thinking'), React.createElement("p", {style: { fontSize:15, color:C.muted, maxWidth:600, lineHeight:1.8, marginBottom:48 }}, 'Every mind operates through four cognitive modes. Most people have never been taught to identify them, let alone coordinate them.'), React.createElement("div", {style: { display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(min(200px, 100%), 1fr))', gap:12, marginBottom:48 }}, Object.keys(FOUR_BRAINS).map(key=>(
                React.createElement(BrainCard, {key: key, brainKey: key, compact: true, active: active===key, onClick: ()=>setActive(key)})
                    ...
                    ))), React.createElement("div", {className: "card", style: { padding:'24px' }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:3, color:'#F87171', marginBottom:16 }}, 'Blind spots'), brain.weaknesses.map((w,i)=>(
    ...
    function CFIView({ setView, user, setShowAuth, cfiResult, setCfiResult }) {
      ...
      return (
        React.createElement("div", {style: { paddingTop:80, paddingBottom:40 }}, React.createElement("div", {style: { maxWidth:700, margin:'0 auto', padding:'40px 24px', width:'100%' }}, React.createElement("div", {style: { display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:32 }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:3, color:C.muted }}, 'CFI ·', step+1, '/', CFI_ITEMS.length), React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:3, color:C.cyan }}, Math.round(progress), '%')), React.createElement("div", {style: { height:2, background:C.panel, borderRadius:2, marginBottom:48, overflow:'hidden' }}, React.createElement("div", {style: { width:`${progress}%`, height:'100%', background:C.cyan, borderRadius:2, transition:'width 0.4s ease' }})), React.createElement("div", {key: step, style: { animation:'fadeUp 0.4s ease both' }}, React.createElement("div", {style: { display:'flex', alignItems:'center', gap:12, marginBottom:24 }}, React.createElement("div", {style: { ...mono, fontSize:18, color:brainInfo.color }}, brainInfo.symbol), React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:3, color:brainInfo.color }}, FOUR_BRAINS[item.brain]?.label || 'COGNITIVE')), React.createElement("div", {style: { ...syne, fontSize:20, fontWeight:700, color:C.text, lineHeight:1.3, marginBottom:48 }}, '"', item.text, '"'), React.createElement("div", {style: { display:'grid', gridTemplateColumns:'repeat(5, 1fr)', gap:8 }}, labels.map((label,i)=>{
                  const val = i+1;
    ...
    function AnalyticsView({ cfiResult, sessions, lessonProgress }) {
      ...
      return (
        React.createElement("div", {style: { paddingTop:80, paddingBottom:100 }}, React.createElement("div", {style: { maxWidth:1200, margin:'0 auto', padding:'40px 24px' }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:4, color:C.cyan, marginBottom:16 }}, 'Analytics'), React.createElement("h1", {style: { ...syne, fontSize:32, fontWeight:800, color:C.text, marginBottom:16 }}, 'Your cognitive', React.createElement("br", null), 'performance map'), React.createElement("p", {style: { fontSize:15, color:C.muted, maxWidth:560, lineHeight:1.8, marginBottom:48 }}, 'Track your thinking evolution, mode balance, and training effectiveness.'), !cfiResult ? (
              React.createElement("div", {className: "card", style: { padding:'60px', textAlign:'center' }}, React.createElement("div", {style: { ...mono, fontSize:48, color:C.dim, marginBottom:24 }}, '◎'), React.createElement("div", {style: { ...syne, fontSize:22, fontWeight:700, color:C.text, marginBottom:12 }}, 'No data yet'), React.createElement("div", {style: { fontSize:14, color:C.muted, marginBottom:32, maxWidth:400, margin:'0 auto 32px' }}, 'Complete the CFI assessment to generate your profile and unlock analytics.'), React.createElement("button", {className: "btn-primary", onClick: ()=>{}}, 'Take CFI assessment →'))
            ) : (
              React.createElement(React.Fragment, null, React.createElement("div", {style: { display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(min(180px, 100%), 1fr))', gap:16, marginBottom:40 }}, [
                    ...
                    React.createElement("div", {key: i, className: "card", style: { padding:'24px' }}, React.createElement("div", {style: { ...mono, fontSize:8, letterSpacing:3, color:C.muted, marginBottom:12 }}, s.label), React.createElement("div", {style: { display:'flex', alignItems:'baseline', gap:4 }}, React.createElement("div", {style: { ...syne, fontSize:s.small?18:32, fontWeight:800, color:s.color }}, s.value), s.unit && React.createElement("div", {style: { ...mono, fontSize:10, color:C.muted }}, s.unit)))
                  ))), React.createElement("div", {style: { display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(min(300px, 100%), 1fr))', gap:24, marginBottom:40 }}, React.createElement("div", {className: "card", style: { padding:'32px' }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:3, color:C.cyan, marginBottom:24 }}, 'Mode fragmentation'), Object.entries(cfiResult.dimScores).map(([dim,score])=>{
                      ...
                      })), React.createElement("div", {style: { marginTop:24, padding:'16px', background:C.deep, borderRadius:2, border:`1px solid ${C.border}` }}, React.createElement("div", {style: { ...mono, fontSize:8, letterSpacing:3, color:C.muted, marginBottom:8 }}, 'Dominant mode'), React.createElement("div", {style: { ...syne, fontSize:16, fontWeight:800, color:C.brains[cfiResult.dominantBrain]?.color||C.cyan }}, FOUR_BRAINS[cfiResult.dominantBrain]?.label || 'N/A')))), React.createElement("div", {className: "card", style: { padding:'32px' }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:3, color:C.cyan, marginBottom:24 }}, 'Lesson progress'), LESSONS.map((lesson,i)=>{
    ...
    function LessonsView({ setView, user, session, paystackKey, setShowAuth, isPro, setIsPro, isEnterprise, lessonProgress, setLessonProgress, proPrice = 600000 }) {
      ...
      if (activeLesson) {
        ...
        return (
          React.createElement("div", {style: { paddingTop:80, paddingBottom:100, minHeight:'100vh' }}, React.createElement("div", {style: { maxWidth:760, margin:'0 auto', padding:'40px 24px' }}, React.createElement("div", {style: { display:'flex', alignItems:'center', gap:16, marginBottom:32 }}, React.createElement("button", {className: "btn-ghost", onClick: ()=>{ setActiveLesson(null); setPage(0); }}, '← Manuals'), React.createElement("div", {style: { flex:1, height:1, background:C.border }}), React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:3, color:C.muted }}, page+1, '/', content.pages.length)), React.createElement("div", {style: { height:2, background:C.panel, borderRadius:2, marginBottom:48, overflow:'hidden' }}, React.createElement("div", {style: { width:`${((page+1)/content.pages.length)*100}%`, height:'100%', background:col, borderRadius:2, transition:'width 0.4s ease' }})), React.createElement("div", {key: `${activeLesson}-${page}`, style: { animation:'fadeUp 0.4s ease both' }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:3, color:col, marginBottom:12 }}, 'Lesson', activeLesson, '·', lesson.level.toUpperCase()), React.createElement("h1", {style: { ...syne, fontSize:24, fontWeight:800, color:C.text, marginBottom:32, lineHeight:1.1 }}, pageData.title), React.createElement("div", {className: "card", style: { padding:'32px 36px', position:'relative', overflow:'hidden' }}, React.createElement("div", {style: { position:'absolute', top:0, left:0, width:2, height:'100%', background:col }}), pageData.body.split('\n\n').map((para,i)=>(
      ...
      return (
        React.createElement("div", {style: { paddingTop:80, paddingBottom:100 }}, React.createElement("div", {style: { maxWidth:1200, margin:'0 auto', padding:'40px 24px' }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:4, color:C.cyan, marginBottom:16 }}, 'Lesson manuals'), React.createElement("h1", {style: { ...syne, fontSize:32, fontWeight:800, color:C.text, marginBottom:16, lineHeight:1.05 }}, 'Cognitive', React.createElement("br", null), 'training documents'), React.createElement("p", {style: { fontSize:15, color:C.muted, maxWidth:560, lineHeight:1.8, marginBottom:48 }}, 'Five structured manuals that form the complete NeuralFusion™ curriculum. Each is a cognitive transformation, not just information.'), React.createElement("div", {style: { display:'flex', flexDirection:'column', gap:16 }}, LESSONS.map((lesson,i)=>{
              ...
              React.createElement("div", {className: "card", style: { marginTop:20, padding:'40px', textAlign:'center', borderColor:'rgba(76,247,192,0.25)', background:'rgba(5,20,38,0.8)' }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:3, color:'#4CF7C0', marginBottom:16 }}, 'NeuralFusion™ Enterprise'), React.createElement("div", {style: { ...syne, fontSize:24, fontWeight:800, color:C.text, marginBottom:8 }}, 'Deploy it across your organisation'), React.createElement("div", {style: { ...mono, fontSize:28, fontWeight:800, color:'#4CF7C0', marginBottom:16 }}, '₦', ENTERPRISE_PRICE_DISPLAY), React.createElement("div", {style: { fontSize:14, color:C.muted, marginBottom:32, maxWidth:480, margin:'0 auto 32px', lineHeight:1.8 }}, 'Cohort management · CFI data entry · Facilitator dashboard · 5-lesson programme · Clarity Delta™ reporting'), React.createElement("button", {style: { ...syne, fontSize:13, fontWeight:700, padding:'14px 36px', background:'#4CF7C0', color:'#050C1A', border:'none', cursor:'pointer', borderRadius:2 }, onClick: ()=>setView('enterprise')}, 'Explore enterprise →'))
            )))
      );
    }
    // ═══════════════════════════════════════════════════════════════════
              ...
              React.createElement(React.Fragment, null, tab === 'overview' && (
                  ...
                  React.createElement("div", null, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:3, color:C.muted, marginBottom:20 }}, 'Edits are saved to localStorage. Changes take effect on next app reload. The core lesson data in code is not modified.'), editingLesson !== null ? (
                      React.createElement("div", {className: "card", style: { padding:'32px' }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:3, color:C.cyan, marginBottom:16 }}, 'EDITING: LESSON', lessonDraft.id), React.createElement("div", {style: { display:'flex', flexDirection:'column', gap:16 }}, [
                          ...
                          )), React.createElement("div", null, React.createElement("div", {style: { ...mono, fontSize:8, letterSpacing:2, color:C.muted, marginBottom:5 }}, 'Free'), React.createElement("div", {style: { display:'flex', gap:10 }}, [true, false].map(v => (
    ...
    // ── Enterprise Styles ──────────────────────────────────────────────
    const ES = {
      tag: { fontSize:'0.6rem', letterSpacing:'0.2em', color:EC.muted, textTransform:'uppercase', marginBottom:'0.75rem' },
      h1: { fontFamily:"'DM Serif Display', serif", fontSize:'clamp(2.2rem,5vw,4rem)', lineHeight:1.05, letterSpacing:'-0.02em', marginBottom:'1.5rem', color:EC.text },
      h2: { fontFamily:"'DM Serif Display', serif", fontSize:'clamp(1.5rem,3vw,2.5rem)', lineHeight:1.1, marginBottom:'1rem', color:EC.text },
      ...
      btnPrimary: { fontFamily:"'Space Mono', monospace", fontSize:'0.68rem', letterSpacing:'0.15em', textTransform:'uppercase', color:EC.bg, background:EC.accent, border:'none', padding:'0.9rem 1.75rem', cursor:'pointer' },
      btnGhost:   { fontFamily:"'Space Mono', monospace", fontSize:'0.68rem', letterSpacing:'0.15em', textTransform:'uppercase', color:EC.accent, background:'transparent', border:`1px solid rgba(76,247,192,0.4)`, padding:'0.9rem 1.75rem', cursor:'pointer' },
      btnGold:    { fontFamily:"'Space Mono', monospace", fontSize:'0.68rem', letterSpacing:'0.15em', textTransform:'uppercase', color:EC.bg, background:EC.gold, border:'none', padding:'0.9rem 1.75rem', cursor:'pointer' },
      ...
      label:      { fontSize:'0.6rem', letterSpacing:'0.15em', color:EC.muted, textTransform:'uppercase', display:'block', marginBottom:'0.4rem' },
      navTab: (active) => ({ fontSize:'0.62rem', letterSpacing:'0.12em', textTransform:'uppercase', padding:'0.5rem 1rem', border:`1px solid ${active?EC.accent:EC.border}`, background:active?'rgba(76,247,192,0.1)':'transparent', color:active?EC.accent:EC.muted, cursor:'pointer', transition:'all 0.2s' }),
    };
    ...
    function App() {
      ...
      if (authLoading) return (
        React.createElement("div", {style: { background:C.void, minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center' }}, React.createElement("div", {style: { textAlign:'center' }}, React.createElement("div", {style: { ...mono, fontSize:36, color:C.cyan, animation:'neuralPulse 2s ease-in-out infinite' }}, '◈'), React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:3, color:C.muted, marginTop:16 }}, 'Initializing...')))
      );
