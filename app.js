const { useState, useEffect, useCallback, useRef, useMemo } = React;
    ...
    const getPlatformSetting = async (key) => {
      try { const {data} = await sb.from('platform_settings').select('value').eq('key',key).maybeSingle(); return data?.value ?? null; } catch(_){ return null; }
    };
      ...
      return (
        React.createElement("div", {onClick: onClick, style: {
          ...
          position:'relative', overflow:'hidden',
            ...
            }}, b.symbol), React.createElement("div", {style: {flex:1}}, React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:b.color, marginBottom:4 }}, 'BRAIN:', b.code), React.createElement("div", {style: { ...syne, fontSize:compact?15:18, fontWeight:700, color:C.text, marginBottom:compact?0:8 }}, brain.label), !compact && React.createElement("div", {style: { fontSize:12, color:C.muted, lineHeight:1.5 }}, brain.tagline))), !compact && (
    ...
    function AuthModal({ onClose, onSuccess, initialTab = 'login' }) {
      ...
      return (
          ...
          backdropFilter:'blur(8px)',
        }}, React.createElement("div", {className: "card fade-up", style: { maxWidth:420, width:'100%', padding:'36px 32px', position:'relative' }}, React.createElement("button", {onClick: onClose, style: { position:'absolute', top:16, right:16, background:'none', border:'none', color:C.muted, fontSize:20, cursor:'pointer', lineHeight:1 }}, '×'), React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:C.cyan, marginBottom:20 }}, 'Authentication'), React.createElement("div", {style: { ...syne, fontSize:24, fontWeight:800, color:C.text, marginBottom:6 }}, title), React.createElement("div", {style: { fontSize:13, color:C.muted, marginBottom:28 }}, sub), (tab==='login'||tab==='signup') && (
              React.createElement("div", {style: { display:'flex', gap:2, marginBottom:24, background:C.deep, padding:4, borderRadius:2 }}, ['login','signup'].map(t=>(
                  React.createElement("button", {key: t, onClick: ()=>{ setTab(t); setMsg({text:'',type:''}); }, style: {
                    ...
                    letterSpacing:1, borderRadius:2, border:'none', cursor:'pointer',
      ...
      return (
        React.createElement(React.Fragment, null, React.createElement("nav", {style: {
            ...
            borderBottom:`1px solid ${C.border}`,
                ...
                }}, '◈'), React.createElement("div", null, React.createElement("div", {style: { ...syne, fontSize:14, fontWeight:800, color:C.text, letterSpacing:1 }}, 'NeuralFusion™'), React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:C.muted }}, 'Cognitive OS'))), React.createElement("div", {className: "desktop-nav"}, navItems.map(item => (
      ...
      return (
        React.createElement("div", {className: "bottom-nav", style: {
          ...
          borderTop:`1px solid ${C.border}`,
            ...
            }}, React.createElement("div", {style: { ...mono, fontSize:16, color:view===item.v?C.cyan:C.dim, transition:'color 0.2s' }}, item.symbol), React.createElement("div", {style: { ...inter, fontSize:9, letterSpacing:1, color:view===item.v?C.cyan:C.dim, fontWeight:view===item.v?600:400, transition:'color 0.2s' }}, item.label))
          )))
      );
    }
...
function HomeView({ setView, user, setShowAuth, cfiResult, lessonProgress, sessions }) {
  ...
  return (
    React.createElement("div", {style: { paddingTop:80, paddingBottom:80, background:'var(--void)' }}, React.createElement("div", {style: {
        ...
        pointerEvents:'none', zIndex:0,
          ...
          React.createElement("div", {className: "bento-grid", style: { marginBottom:'var(--bento-gap-lg)' }}, [
              ...
              React.createElement("div", {key: i, className: "bento-card bento-p-md bento-col-3 bento-tab-1 bento-card-small bento-shimmer", style: { display:'flex', flexDirection:'column', justifyContent:'space-between' }}, React.createElement("div", {style: { display:'flex', justifyContent:'space-between', alignItems:'flex-start' }}, React.createElement("div", {style: {
                  ...
                  fontFamily:"'Syne', sans-serif",
                  fontSize:22, fontWeight:800, color:stat.color, lineHeight:1,
          ...
          React.createElement("div", {className: "bento-grid", style: { marginBottom:'var(--bento-gap-lg)' }}, [
        ...
        ), React.createElement("div", {style: { marginBottom:'var(--bento-gap-lg)' }}, React.createElement("div", {className: "bento-section-header"}, React.createElement("div", {style: { fontFamily:"'Space Mono', monospace", fontSize:11, letterSpacing:1, color:'#C4A050', marginBottom:12 }}, 'Cognitive command center'), React.createElement("div", {style: { fontFamily:"'Syne', sans-serif", fontSize:'clamp(17px,2.5vw,24px)', fontWeight:800, color:'#F0E8D0', letterSpacing:'-0.02em', lineHeight:1.1, marginBottom:12 }}, 'Your live cognition dashboard'), React.createElement("p", {style: { fontFamily:"'DM Sans', sans-serif", fontSize:14, color:'#8A7A5A', lineHeight:1.8, maxWidth:'60ch' }}, 'Track fragmentation, synthesis, pressure stability, and integrated thinking performance in real time.')), React.createElement("div", {className: "bento-grid"}, React.createElement("div", {className: "bento-card bento-card-bright bento-p-lg bento-card-large bento-col-8 bento-tab-2", style: { display:'flex', flexDirection:'column' }}, React.createElement("div", {className: "bento-grid-lines"}), React.createElement("div", {style: { display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:24 }}, React.createElement("div", null, React.createElement("span", {className: "bento-label"}, 'Cognitive balance'), React.createElement("div", {style: { fontFamily:"'Syne', sans-serif", fontSize:24, fontWeight:800, color:'#C4A050', lineHeight:1, letterSpacing:'-0.02em' }}, cogScore ? `${cogScore}%` : '84%')), React.createElement("div", {style: {
              ...
              fontFamily:"'Space Mono', monospace", fontSize:24, color:'rgba(196,160,80,0.15)',
      ...
      return (
        React.createElement("div", {style: { paddingTop:80, paddingBottom:100 }}, React.createElement("div", {style: { maxWidth:1200, margin:'0 auto', padding:'40px 24px' }}, React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1.5, color:C.cyan, marginBottom:16 }}, 'Four Brains framework'), React.createElement("h1", {style: { ...syne, fontSize:20, fontWeight:800, color:C.text, marginBottom:16, lineHeight:1.05 }}, 'The architecture', React.createElement("br", null), 'of human thinking'), React.createElement("p", {style: { fontSize:15, color:C.muted, maxWidth:600, lineHeight:1.8, marginBottom:48 }}, 'Every mind operates through four cognitive modes. Most people have never been taught to identify them, let alone coordinate them.'), React.createElement("div", {style: { display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(min(200px, 100%), 1fr))', gap:12, marginBottom:48 }}, Object.keys(FOUR_BRAINS).map(key=>(
                React.createElement(BrainCard, {key: key, brainKey: key, compact: true, active: active===key, onClick: ()=>setActive(key)})
                  ...
                  React.createElement("div", {key: i, className: "card", style: { padding:'24px', borderColor:`${item.color}22` }}, React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:item.color, marginBottom:12 }}, item.label), React.createElement("div", {style: { ...syne, fontSize:16, fontWeight:700, color:C.text, marginBottom:12 }}, item.title), React.createElement("div", {style: { fontSize:13, color:C.muted, lineHeight:1.7 }}, item.desc))
                ))))))
      );
    }
      ...
      return (
        React.createElement("div", {style: { paddingTop:80, paddingBottom:100 }}, React.createElement("div", {style: { maxWidth:1200, margin:'0 auto', padding:'40px 24px' }}, React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1.5, color:C.cyan, marginBottom:16 }}, 'Training system'), React.createElement("h1", {style: { ...syne, fontSize:22, fontWeight:800, color:C.text, marginBottom:16, lineHeight:1.05 }}, 'Precision training', React.createElement("br", null), 'Protocols'), React.createElement("p", {style: { fontSize:15, color:C.muted, maxWidth:560, lineHeight:1.8, marginBottom:48 }}, 'Each module is a structured cognitive exercise that activates, challenges, and integrates your four brain modes. Sessions are 8–15 minutes.'), React.createElement("div", {style: { display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(min(300px, 100%), 1fr))', gap:24, marginBottom:64 }}, modules.map((mod,i)=>(
              ...
              React.createElement("div", null, React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:C.cyan, marginBottom:20 }}, 'Recent sessions'), React.createElement("div", {style: { display:'flex', flexDirection:'column', gap:8 }}, sessions.slice(0,5).map((s,i)=>(
                    React.createElement("div", {key: s.id, className: "card", style: { padding:'16px 24px', display:'flex', justifyContent:'space-between', alignItems:'center' }}, React.createElement("div", null, React.createElement("div", {style: { ...syne, fontSize:14, fontWeight:700, color:C.text }}, s.title), React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:1, color:C.muted, marginTop:4 }}, s.date)), React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:1, color:C.dim }}, 'Done ✓'))
                  ))))
            )))
      );
    }
    ...
    function AnalyticsView({ cfiResult, sessions, lessonProgress }) {
      ...
      return (
        React.createElement("div", {style: { paddingTop:80, paddingBottom:100 }}, React.createElement("div", {style: { maxWidth:1200, margin:'0 auto', padding:'40px 24px' }}, React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1.5, color:C.cyan, marginBottom:16 }}, 'Analytics'), React.createElement("h1", {style: { ...syne, fontSize:22, fontWeight:800, color:C.text, marginBottom:16 }}, 'Your cognitive', React.createElement("br", null), 'performance map'), React.createElement("p", {style: { fontSize:15, color:C.muted, maxWidth:560, lineHeight:1.8, marginBottom:48 }}, 'Track your thinking evolution, mode balance, and training effectiveness.'), !cfiResult ? (
              React.createElement("div", {className: "card", style: { padding:'60px', textAlign:'center' }}, React.createElement("div", {style: { ...mono, fontSize:20, color:C.dim, marginBottom:24 }}, '◎'), React.createElement("div", {style: { ...syne, fontSize:22, fontWeight:700, color:C.text, marginBottom:12 }}, 'No data yet'), React.createElement("div", {style: { fontSize:14, color:C.muted, marginBottom:32, maxWidth:400, margin:'0 auto 32px' }}, 'Complete the CFI assessment to generate your profile and unlock analytics.'), React.createElement("button", {className: "btn-primary", onClick: ()=>{}}, 'Take CFI assessment →'))
            ) : (
              React.createElement(React.Fragment, null, React.createElement("div", {style: { display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(min(180px, 100%), 1fr))', gap:16, marginBottom:40 }}, [
                    ...
                    React.createElement("div", {key: i, className: "card", style: { padding:'24px' }}, React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:C.muted, marginBottom:12 }}, s.label), React.createElement("div", {style: { display:'flex', alignItems:'baseline', gap:4 }}, React.createElement("div", {style: { ...syne, fontSize:s.small?18:32, fontWeight:800, color:s.color }}, s.value), s.unit && React.createElement("div", {style: { ...mono, fontSize:10, color:C.muted }}, s.unit)))
    ...
    function LessonsView({ setView, user, session, paystackKey, setShowAuth, isPro, setIsPro, isEnterprise, lessonProgress, setLessonProgress, proPrice = 600000 }) {
      ...
      return (
        React.createElement("div", {style: { paddingTop:80, paddingBottom:100 }}, React.createElement("div", {style: { maxWidth:1200, margin:'0 auto', padding:'40px 24px' }}, React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1.5, color:C.cyan, marginBottom:16 }}, 'Lesson manuals'), React.createElement("h1", {style: { ...syne, fontSize:22, fontWeight:800, color:C.text, marginBottom:16, lineHeight:1.05 }}, 'Cognitive', React.createElement("br", null), 'training documents'), React.createElement("p", {style: { fontSize:15, color:C.muted, maxWidth:560, lineHeight:1.8, marginBottom:48 }}, 'Five structured manuals that form the complete NeuralFusion™ curriculum. Each is a cognitive transformation, not just information.'), React.createElement("div", {style: { display:'flex', flexDirection:'column', gap:16 }}, LESSONS.map((lesson,i)=>{
              ...
              React.createElement("div", {className: "card", style: { marginTop:40, padding:'40px', textAlign:'center', borderColor:`${C.cyan}22` }}, React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:C.cyan, marginBottom:16 }}, 'Unlock all lessons'), React.createElement("div", {style: { ...syne, fontSize:24, fontWeight:800, color:C.text, marginBottom:8 }}, 'Pro access'), React.createElement("div", {style: { ...mono, fontSize:20, fontWeight:800, color:C.cyan, marginBottom:16 }}, '₦', (proPrice/100).toLocaleString()), React.createElement("div", {style: { fontSize:14, color:C.muted, marginBottom:32, maxWidth:400, margin:'0 auto 32px' }}, 'One-time payment. Unlocks Lessons 2–5 and the full training system.'), React.createElement("button", {className: "btn-primary", onClick: ()=>{
    ...
    function AboutView({ setView }) {
      const faqs = [
        ...
        { q:'What is the CFI assessment?', a:'The CFI™ measures fragmentation across five cognitive dimensions. It produces a score, a band rating, and a personalised training recommendation.' },
    ...
    function LegalView({ setView }) {
      ...
      return (
        React.createElement("div", {style: { paddingTop: 80, paddingBottom: 120, minHeight: '100vh' }}, React.createElement("div", {style: { maxWidth: 900, margin: '0 auto', padding: '60px 24px 0' }}, React.createElement("div", {style: { marginBottom: 48 }}, React.createElement("div", {style: { ...mono, fontSize: 9, letterSpacing: 4, color: C.cyan, marginBottom: 16, textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: 12 }}, React.createElement("span", {style: { width: 28, height: 1, background: C.cyan, opacity: 0.5, display: 'inline-block' }}), 'Legal Documentation'), React.createElement("h1", {style: { ...syne, fontSize: 'clamp(18px,2.5vw,28px)', fontWeight: 800, color: C.text, letterSpacing: '-0.04em', lineHeight: 0.96, marginBottom: 16 }}, 'Legal &amp;', React.createElement("span", {style: { color: C.cyan }}, 'Compliance')), React.createElement("p", {style: { fontSize: 14, color: C.muted, maxWidth: 520, lineHeight: 1.8 }}, 'Our commitments to your privacy, the terms governing your use of NeuralFusion™, and our data protection practices under the Nigeria Data Protection Act 2023.'), React.createElement("div", {style: { display: 'flex', gap: 32, marginTop: 24, paddingTop: 24, borderTop: `1px solid ${C.border}`, flexWrap: 'wrap' }}, [{ label: 'Effective', value: '4 June 2026' }, { label: 'Governing Law', value: 'Nigeria (NDPA 2023)' }, { label: 'Controller', value: 'Life Edet' }].map((m,i) => (
    ...
    function AdminView({ user, setView, onPriceChange }) {
      ...
      if (loading && users.length === 0) return (
        React.createElement("div", {style: { paddingTop:80, minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center' }}, React.createElement("div", {style: { textAlign:'center' }}, React.createElement("div", {style: { ...mono, fontSize:24, color:C.cyan, animation:'neuralPulse 2s ease-in-out infinite' }}, '◈'), React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:C.muted, marginTop:16 }}, 'LOADING ADMIN DATA...')))
      );
      ...
      return (
        React.createElement("div", {style: { paddingTop:80, paddingBottom:60, minHeight:'100vh' }}, React.createElement("div", {style: { maxWidth:1280, margin:'0 auto', padding:'32px 24px' }}, React.createElement("div", {style: { display:'flex', alignItems:'flex-start', justifyContent:'space-between', flexWrap:'wrap', gap:16, marginBottom:32 }}, React.createElement("div", null, React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:C.cyan, marginBottom:8 }}, 'ADMIN PORTAL · NEURALFUSION™'), React.createElement("div", {style: { ...syne, fontSize:20, fontWeight:800, color:C.text, marginBottom:4 }}, 'Control Dashboard'), React.createElement("div", {style: { fontSize:13, color:C.muted }}, 'Signed in as', React.createElement("span", {style: { color:C.cyan }}, user?.email))), React.createElement("div", {style: { display:'flex', gap:10, alignItems:'center' }}, actionMsg && (
              ...
              React.createElement("div", {style: { textAlign:'center', padding:'60px', color:C.muted }}, React.createElement("div", {style: { ...mono, fontSize:22, color:C.cyan, animation:'neuralPulse 2s ease-in-out infinite' }}, '◈'), React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, marginTop:16 }}, 'LOADING DATA...'))
            ), !loading && (
              React.createElement(React.Fragment, null, tab === 'overview' && (
                  ...
                  React.createElement("div", null, React.createElement("div", {style: { display:'flex', gap:16, marginBottom:24, flexWrap:'wrap' }}, React.createElement("div", {className: "card", style: { padding:'24px 28px', flex:'none' }}, React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:'#8A7A5A', marginBottom:10 }}, 'PRO subscribers'), React.createElement("div", {style: { ...syne, fontSize:40, fontWeight:800, color:'#E2BE78' }}, proUsers.length)), React.createElement("div", {className: "card", style: { padding:'24px 28px', flex:'none' }}, React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:'#8A7A5A', marginBottom:10 }}, 'Conversion rate'), React.createElement("div", {style: { ...syne, fontSize:40, fontWeight:800, color:C.cyan }}, users.length ? Math.round(proUsers.length/users.length*100) : 0, '%')), React.createElement("div", {className: "card", style: { padding:'24px 28px', flex:'none' }}, React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:'#8A7A5A', marginBottom:10 }}, 'EST. REVENUE'), React.createElement("div", {style: { ...syne, fontSize:40, fontWeight:800, color:'#7AAFCF' }}, '₦', ((proUsers.length * proPrice / 100)).toLocaleString()))), React.createElement("div", {className: "card", style: { overflow:'hidden' }}, React.createElement("div", {style: { display:'grid', gridTemplateColumns:'1fr 1.5fr 100px 120px', gap:16, padding:'14px 20px', borderBottom:`1px solid ${C.border}`, background:C.deep }}, ['NAME','EMAIL','STATUS','ACTION'].map(h => (
                          React.createElement("div", {key: h, style: { ...mono, fontSize:11, letterSpacing:1, color:C.muted }}, h)
                  ...
                  React.createElement("div", null, React.createElement("div", {style: { display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(300px,1fr))', gap:24, marginBottom:32 }}, React.createElement("div", {className: "card", style: { padding:'28px', borderColor:'rgba(76,247,192,0.2)' }}, React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:'#4CF7C0', marginBottom:16 }}, 'Create new cohort'), React.createElement("div", {style: { display:'flex', flexDirection:'column', gap:12 }}, [
                          ...
                          React.createElement("div", {key: i, className: "card", style: { padding:'20px 24px', display:'flex', justifyContent:'space-between', alignItems:'center' }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:1, color:C.muted }}, s.label), React.createElement("div", {style: { ...syne, fontSize:22, fontWeight:800, color:s.color }}, s.value))
                  ...
                  React.createElement("div", null, React.createElement("div", {style: { display:'flex', gap:16, marginBottom:24, flexWrap:'wrap', alignItems:'center' }}, React.createElement("div", {style: { display:'flex', gap:4, background:C.deep, padding:4, borderRadius:3, flexWrap:'wrap' }}, ['all', ...localCohorts.map(c=>c.code)].map(f => (
                        ...
                        React.createElement("div", {key: i, className: "card", style: { padding:'20px 24px' }}, React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:C.muted, marginBottom:8 }}, s.label), React.createElement("div", {style: { ...syne, fontSize:22, fontWeight:800, color:s.color }}, s.value))
                  ...
                  React.createElement("div", {style: { display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(min(400px,100%),1fr))', gap:20 }}, React.createElement("div", {className: "card", style: { padding:'40px', position:'relative', overflow:'hidden', borderColor:'rgba(196,160,80,0.3)' }}, React.createElement(ScanLine, null), React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:C.cyan, marginBottom:16 }}, 'PRO plan pricing'), React.createElement("div", {style: { ...syne, fontSize:22, fontWeight:800, color:C.text, marginBottom:8 }}, 'Edit Pro Price'), React.createElement("div", {style: { fontSize:13, color:C.muted, marginBottom:28, lineHeight:1.7 }}, 'Updates the price shown on the platform and passed to Paystack for payment processing.'), React.createElement("div", {style: { marginBottom:20 }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:1, color:C.muted, marginBottom:8 }}, 'CURRENT PRICE (NAIRA)'), React.createElement("div", {style: { ...syne, fontSize:20, fontWeight:800, color:C.cyan, lineHeight:1, marginBottom:4 }}, '₦', (proPrice/100).toLocaleString()), React.createElement("div", {style: { ...mono, fontSize:9, color:C.muted }}, '=', proPrice.toLocaleString(), 'kobo')), React.createElement("div", {style: { marginBottom:20 }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:1, color:C.muted, marginBottom:8 }}, 'NEW PRICE (₦)'), React.createElement("div", {style: { display:'flex', gap:12, alignItems:'center' }}, React.createElement("div", {style: { position:'relative', flex:1 }}, React.createElement("div", {style: { position:'absolute', left:16, top:'50%', transform:'translateY(-50%)', ...syne, fontSize:16, fontWeight:700, color:C.muted }}, '₦'), React.createElement("input", {type: "number", value: priceInput, onChange: e => setPriceInput(e.target.value), style: { paddingLeft:36, fontSize:20, ...syne, fontWeight:700 }, min: "100", step: "100"})), React.createElement("button", {className: "btn-primary", onClick: savePrice, style: { whiteSpace:'nowrap' }}, priceSaved ? '✓ Saved!' : 'Save Price'))), React.createElement("div", {style: { padding:'20px', background:C.deep, borderRadius:2, border:`1px solid ${C.border}` }}, React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:C.muted, marginBottom:8 }}, 'Paystack integration'), React.createElement("div", {style: { fontSize:13, color:C.muted, lineHeight:1.7 }}, 'Live key:', React.createElement("span", {style: { color:C.cyan, fontFamily:'monospace' }}, 'loaded from platform_settings at runtime'), React.createElement("br", null), 'Currency: NGN · Gateway: Paystack inline · Verified server-side'))), React.createElement("div", {className: "card", style: { padding:'40px', position:'relative', overflow:'hidden', borderColor:'rgba(76,247,192,0.2)' }}, React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:'#4CF7C0', marginBottom:16 }}, 'Enterprise plan pricing'), React.createElement("div", {style: { ...syne, fontSize:22, fontWeight:800, color:C.text, marginBottom:8 }}, 'Edit Enterprise Price'), React.createElement("div", {style: { fontSize:13, color:C.muted, marginBottom:28, lineHeight:1.7 }}, 'Sets the displayed price for enterprise cohort enrolment on the platform.'), React.createElement("div", {style: { marginBottom:20 }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:1, color:C.muted, marginBottom:8 }}, 'CURRENT PRICE (NAIRA)'), React.createElement("div", {style: { ...syne, fontSize:20, fontWeight:800, color:'#4CF7C0', lineHeight:1, marginBottom:4 }}, '₦', (entPrice/100).toLocaleString()), React.createElement("div", {style: { ...mono, fontSize:9, color:C.muted }}, '=', entPrice.toLocaleString(), 'kobo')), React.createElement("div", {style: { marginBottom:20 }}, React.createElement("div", {style: { ...mono, fontSize:9, letterSpacing:1, color:C.muted, marginBottom:8 }}, 'NEW PRICE (₦)'), React.createElement("div", {style: { display:'flex', gap:12, alignItems:'center' }}, React.createElement("div", {style: { position:'relative', flex:1 }}, React.createElement("div", {style: { position:'absolute', left:16, top:'50%', transform:'translateY(-50%)', ...syne, fontSize:16, fontWeight:700, color:C.muted }}, '₦'), React.createElement("input", {type: "number", value: entPriceInput, onChange: e => setEntPriceInput(e.target.value), style: { paddingLeft:36, fontSize:20, ...syne, fontWeight:700 }, min: "100", step: "1000"})), React.createElement("button", {className: "btn-primary", onClick: saveEntPrice, style: { whiteSpace:'nowrap' }}, 'Save Price'))), React.createElement("div", {style: { padding:'16px 20px', background:C.deep, borderRadius:2, border:`1px solid ${C.border}`, ...mono, fontSize:10, color:C.muted }}, 'Grant enterprise access manually in the', React.createElement("button", {onClick: () => setTab('users'), style: { background:'none', border:'none', color:C.cyan, cursor:'pointer', ...mono, fontSize:10, padding:0 }}, 'Users tab →'))))
                ), tab === 'settings' && (
    ...
    const ES = {
      ...
      h1: { fontFamily:"'DM Serif Display', serif", fontSize:'clamp(1.3rem,3vw,2rem)', lineHeight:1.05, letterSpacing:'-0.02em', marginBottom:'1.5rem', color:EC.text },
      h2: { fontFamily:"'DM Serif Display', serif", fontSize:'clamp(1.1rem,2.5vw,1.6rem)', lineHeight:1.1, marginBottom:'1rem', color:EC.text },
    ...
    function App() {
      ...
      if (authLoading) return (
        React.createElement("div", {style: { background:C.void, minHeight:'100vh', display:'flex', alignItems:'center', justifyContent:'center' }}, React.createElement("div", {style: { textAlign:'center' }}, React.createElement("div", {style: { ...mono, fontSize:24, color:C.cyan, animation:'neuralPulse 2s ease-in-out infinite' }}, '◈'), React.createElement("div", {style: { ...mono, fontSize:11, letterSpacing:1, color:C.muted, marginTop:16 }}, 'Initializing...')))
      );
